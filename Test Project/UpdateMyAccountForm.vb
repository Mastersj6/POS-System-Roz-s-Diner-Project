Public Class UpdateMyAccountForm
    ...
    Private Sub UpdateMyAccountForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If MenuForm.txtCustomerID.Text = String.Empty Then
            MessageBox.Show("No customer selected.")
            Me.Close()
        Else
            DB.AddParam("@ID", MenuForm.txtCustomerID.Text)
